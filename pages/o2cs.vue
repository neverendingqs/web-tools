<template>
  <div>
    ...
    <p>
      Get the <code>authorization_code</code>, <code>access_token</code> and
      <code>refresh_token</code> for any registered OAuth 2.0 client!
    </p>
    <p>
    ...
    <b-form>
          ...
          >
            <b-input-group>
              ...
              <b-input-group-append>
                <b-button v-clipboard:copy="form.authCode" variant="primary"
                  >Copy</b-button
                >
              </b-input-group-append>
            </b-input-group>
      ...
      <b-row v-if="isAuthCode">
        <b-col>
          <b-button variant="primary" @click="tradeInAuthCode">
            Trade in Authorization Code
            <b-spinner v-if="workflow.showSpinner" small />
          </b-button>
        </b-col>
      </b-row>
        ...
        <b-col lg="6">
          ...
          >
            <b-input-group>
              ...
              ></b-form-input>
              <b-input-group-append>
                <b-button v-clipboard:copy="form.accessToken" variant="primary"
                  >Copy</b-button
                >
              </b-input-group-append>
            </b-input-group>
        ...
        <b-col lg="6">
          ...
          >
            <b-input-group>
              ...
              ></b-form-input>
              <b-input-group-append>
                <b-button v-clipboard:copy="form.refreshToken" variant="primary"
                  >Copy</b-button
                >
              </b-input-group-append>
            </b-input-group>
      ...
      <b-row v-if="isRefreshToken">
        <b-col>
          <b-button variant="primary" @click="tradeInRefreshToken">
...
export default {
  ...
  methods: {
    ...
    async tradeInAuthCode() {
      ...
      const { accessToken, refreshToken } = await this.requestTokens(
        body,
        AUTH_CODE
      );
      ...
      this.form.refreshToken =
        refreshToken || 'Not provided by authorization server.';
    ...
    async tradeInRefreshToken() {
      ...
      this.form.accessToken = accessToken;
      this.form.refreshToken = refreshToken || this.form.refreshToken;
      this.workflow.state = REFRESH_TOKEN;
    },
